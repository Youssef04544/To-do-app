  ...
  return (
    <div className='mx-[35%] my-[5%] h-[80vh] bg-white rounded-lg'>
      ...
      <form className=' w-full flex justify-center p-4 relative' onSubmit={(e) => addTodo(e)}>
        <input className='border-2 w-2/3 p-2 rounded-md' autoFocus ref={inputRef} type="text" placeholder='add a new task...' value={task} onChange={e => setTask(e.target.value)} />
